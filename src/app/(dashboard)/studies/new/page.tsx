    ...
    try {
      ...
      const response = await fetch('/api/studies', {
        ...
        body: JSON.stringify({
          ...
          title: formData.title || `دراسة جدوى - ${new Date().toLocaleDateString('ar-SA')}`,
          description: formData.description || '',
          type: formData.studyType,
          language: formData.language,
          aiModel: formData.aiModel,
          currency: formData.currency,
          includeFinancialAnalysis: formData.includeFinancialAnalysis,
          includeMarketAnalysis: formData.includeMarketAnalysis,
          includeTechnicalAnalysis: formData.includeTechnicalAnalysis,
          includeRiskAnalysis: formData.includeRiskAnalysis,
          includeLegalAnalysis: formData.includeLegalAnalysis,
          includeEnvironmentalAnalysis: formData.includeEnvironmentalAnalysis,
